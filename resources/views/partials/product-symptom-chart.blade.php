<div class="dark">
    <div id="product-choice" class="container padded">
        ...
        <div id="chart" class="half">
            <table class="styled">
                ...
                <tr>
                    <td>Relieves Pain & Itching</td>
                    <td class="check"><i class="fa fa-check fa-2x"></i></td>
                    <td class="check"><i class="fa fa-check fa-2x"></i></td>
                    <td class="check"><i class="fa fa-check fa-2x"></i></td>
                </tr>
                <tr>
                    <td>Reduces Swelling</td>
                    <td class="check"></td>
                    <td class="check"></td>
                    <td class="check"><i class="fa fa-check fa-2x"></i></td>
                </tr>
                <tr>
                    <td>Protection from Irritation</td>
                    <td class="check"></td>
                    <td class="check"><i class="fa fa-check fa-2x"></i></td>
                    <td class="check"><i class="fa fa-check fa-2x"></i></td>
                </tr>
                <tr>
                    <td>Hygienic Application</td>
                    <td class="check"><i class="fa fa-check fa-2x"></i></td>
                    <td class="check"><i class="fa fa-check fa-2x"></i></td>
                    <td class="check"><i class="fa fa-check fa-2x"></i></td>
                </tr>
                <tr>
                    <td>Convenient, Portable</td>
                    <td class="check"></td>
                    <td class="check"><i class="fa fa-check fa-2x"></i></td>
                    <td class="check"><i class="fa fa-check fa-2x"></i></td>
                </tr>
